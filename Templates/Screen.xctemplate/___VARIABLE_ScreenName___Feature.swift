...
final class ___VARIABLE_ScreenName___Feature<VC: ViewProtocol>: FeatureProtocol {
    ...
    // MARK: - Properties
    private let factory: ___VARIABLE_ScreenName___ServiceFactoryProtocol
    private var viewHandler: ___VARIABLE_ScreenName___ViewServicesHandlerProtocol
    ...
    init(
           ...
           factory: ___VARIABLE_ScreenName___ServiceFactoryProtocol = ___VARIABLE_ScreenName___ServiceFactory(),
           viewHandler: ___VARIABLE_ScreenName___ViewServicesHandlerProtocol = ___VARIABLE_ScreenName___ViewServicesHandler(),
